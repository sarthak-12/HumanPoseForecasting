...
# fixing the hidden size to 34 to be consistent with the input size
config['parameters']['hidden_size'] = {'value': 34}
...
def train():
    ...
    # removing the encoder and the decoder and modifying the recurrent unit to match input size
